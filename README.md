...
I am a **technical writer** with experience in **software and API documentation for developers**, using **docs-as-code** and **open source** workflows. Sometimes I write code for hobby projects, as it also helps me understand the technology and my target audience better.

If you are interested in hiring me, here's my [resume](assets/technical_writer_souvik_sarkar.pdf).

### Professional technical documentation

Over the last several years, most  of my professional work has been open source and available on my GitHub activities. Here are a few projects where I have contributed:
...
- **SUSE Linux Enterprise**:
  ...
  - [Compliance and Certification for SLE](https://github.com/SUSE/doc-unversioned/pulls?q=is%3Apr+is%3Aclosed+author%3Asounix000)
